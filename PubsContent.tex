...
%{\bf h-index ---}%
%As of 2025-11-02: 67 (according to Google Scholar), or 59 (according
%to INSPIRE).  Both include collaboration papers.

{\bf Most important Publications ---}%
%Citation counts from Google Scholar.
\begin{etaremune}
\item
	Gergő Róth, Ákos Kuki, {\bf Aron Kipyegon Rop}, Lajos Nagy, Zuura Kyzy Kaldybek, Máté Benedek, Miklós Zsuga, Tibor Nagy, Sándor Kéki(2025).
  {\it Rapid Copolymer Analysis of Unresolved Mass Spectra by Artificial Intelligence},Analytical Chemistry
  \href{http://dx.doi.org/10.1021/acs.analchem.5c03495}{ 2025 97 {(\bf36)}, 19801-19808}
%  \arxiv{1501.07274}.
%  \citeCount{1462}
%\item
%  Barack,~L., {\it et al.}
...
\begin{etaremune}
	\item
	Róth, G. ,  Kuki, Á. ,  Nagy, T. ,  {\bf Rop, AK} ,  Zsuga, M. ,  Nagy, L. ,   Kaldybek, KZ ,  Benedek, M. ,  Kéki, S. {\it Application of algorithms and neural networks to evaluate block copolymer mass spectra}
	In: XXXI. International Conference on Chemistry = 31st International Conference on Chemistry, Transylvanian Hungarian Technical Scientific Society, Cluj-Napoca, 48, {\bf 2025}, (ISSN 2734-7109)
	\item 
	{\bf Rop, AK} , Róth, G. , Pardi-Tóth, VC , Zsuga, M. , Nagy, T. , Kéki, S. : {\it Rapid Synthesis of Thermoresponsive PNIPA-b-PNAM Block Copolymers.}
	In: Young Researchers` International Conference on Chemistry and Chemical Engineering (YRICCCE V), Babeș-Bolyai University, Faculty of Chemistry and Chemical Engineering, Cluj.,  50, {\bf 2025}.
	\item 
	{\bf Rop, AK }, Nagy, T. , Róth, G. , Kuki, Á. , Ayoade-Alabi, EA , Nassozi, NAC , Zsuga, M. , Kéki, S. : {\it Design and Synthesis of Thermoresponsive Copolymers.}
	In: XXXI. Nemzetkogő Kegyészkonferencia = 31st International Conference on Chemistry, Transylvanian Hungarian Technical Scientific Society, Cluj-Napoca, 47, {\bf 2025}, (ISSN 2734-7109)
	\item 
	{\bf Rop, AK} , Nagy, T. , Kuki, Á. , Kéki, S. : {\it Self-Assembly of Pluronic-Type Amphiphilic Block Copolymers.}
	In: 4th Young Researchers` International Conference on Chemistry and Chemical Engineering YRICCCE IV - {\bf 2023}: Program and Book of Abstracts, Hungarian Chemical Society, Debrecen., 68, 2023. ISBN: 9786156018168
\end {etaremune}
...
%  {\bf Stein,~L.~C.},
%  (2025)
%  {\it Parameter matching between horizon quasi-local and point-particle
%    definitions at 1PN for quasi-circular and non spinning BBH systems in
%    harmonic gauge},
%  \arxiv{2510.25618}.
%  \citeCount{0}
%\item
...
%\section{Unrefereed Publications}
%\secstartswithlist{}%
%\addtocounter{pubCounter}{-1}%
%\begin{etaremune}[start=\value{pubCounter}]
%\item
